...
// list = [1,2,3]// WONT WORK as it replaces the list
content = {
    id: 123,
    name: "Kevin"
}
console.log(content.id, content.name) //dot notation
const field = "name"
console.log(content["id"], content[field]) //bracket notation

data = [
    {id: 111, name:"Kevin"},
    {id: 222, name:"Nina"}
]
data.forEach(person =>console.log(person.id, person.name));
